...
public class CCAComumCodeCoverageTest {
	...
	public void testSuperficialCCAComumCodeCoverage() throws Exception {
		CCAComumCodeCoverageTest.superficialCCAComumCodeCoverage(new InstituicaoCooperativaSCIDTO());
		CCAComumCodeCoverageTest.superficialCCAComumCodeCoverage(new PesquisaContaCapitalDTO());
	}
