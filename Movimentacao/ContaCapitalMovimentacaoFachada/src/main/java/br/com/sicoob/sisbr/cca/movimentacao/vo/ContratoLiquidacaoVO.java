...
public class ContratoLiquidacaoVO extends BancoobVo {
	...
	private DateTimeDB dataUltimaLiquidacao;
	private DateTimeDB dataEntradaOperacao;
	...
	public DateTimeDB getDataUltimaLiquidacao() {
		return dataUltimaLiquidacao;
	}
	public void setDataUltimaLiquidacao(DateTimeDB dataUltimaLiquidacao) {
		this.dataUltimaLiquidacao = dataUltimaLiquidacao;
	}
	public DateTimeDB getDataEntradaOperacao() {
		return dataEntradaOperacao;
	}
	public void setDataEntradaOperacao(DateTimeDB dataEntradaOperacao) {
