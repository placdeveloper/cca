...
/**
 * A Classe ConsultaDebitoIndeterminadoDTO
 * 
 * @author marco.nascimento
 */
public class ConsultaDebitoIndeterminadoRenDTO extends BancoobDto {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -8832006077427026207L;
