 ...
 */
public class DevolucaoRenDTO extends BancoobDto {

	/** A constante serialVersionUID. */
	private static final long serialVersionUID = 815352157595284024L;
	 ...
	 */
	public Long getIdModalidadeAplicacao() {
	 ...
	 */
	public void setIdModalidadeAplicacao(Long idModalidadeAplicacao) {
	...
	public String toString() {
		return "DevolucaoRenDTO [idContaCapital=" + idContaCapital + ", idInstituicao=" + idInstituicao
				+ ", numContaCapital=" + numContaCapital + ", vlrDevolucao=" + vlrDevolucao + ", vlrAVista=" + vlrAVista
				+ ", qtdParcelas=" + qtdParcelas + ", vlrParcelas=" + vlrParcelas + ", dtInicioParcelamento="
				+ dtInicioParcelamento + ", tipoInteg=" + tipoInteg + ", numContaCorrente=" + numContaCorrente
				+ ", dataHoraAtualizacao=" + dataHoraAtualizacao + ", idPessoaLegado=" + idPessoaLegado + ", idPessoa="
				+ idPessoa + ", idMotivoDevolucao=" + idMotivoDevolucao + ", qtdAplicacao=" + qtdAplicacao
				+ ", vlrPorAplicacao=" + vlrPorAplicacao + ", idModalidadeAplicacao=" + idModalidadeAplicacao + "]";
	}
