...
/**
 * A Classe QuadroGeralAssociadoDTO
 * 
 * @author marco.nascimento
 */
public class QuadroGeralAssociadoDTO extends BancoobDto {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8102466447765422716L;
