package br.com.sicoob.sisbr.cca.movimentacao.subscricao
{
	...
	public class ParcelamentoCadastro extends ParcelamentoCadastroView{		
		...
		public 	var movimentacaoSubscricaoRen:MovimentacaoSubscricaoRen;
		...
		private function configurarServico():void {
			...
			onDestinoRecuperado(movimentacaoSubscricaoRen.destino);
		...
		private function validar():Boolean {			
			...
			if(dataVencimento < dataSubsc){
				Alerta.show("A data da parcela deve ser maior ou igual a parcela à vista.", "ATENÇÃO", Alerta.ALERTA_OK, vlrParcela);
				return false;
			}						
