package
{
	...
	import br.com.sicoob.sisbr.cca.cadastro.cadastroconfiguracao.CadastroValorConfiguracaoCapitalEdicao;
	import br.com.sicoob.sisbr.cca.cadastro.cadastroconfiguracao.CadastroValorConfiguracaoCapitalView;
	
	public class CadastroValorConfiguracaoCapital extends CadastroValorConfiguracaoCapitalView
	{		
		...
		public function CadastroValorConfiguracaoCapital()
		{
			super();
		...
		private function abrirJanela():void{
			...
			var app:CadastroValorConfiguracaoCapitalEdicao = new CadastroValorConfiguracaoCapitalEdicao();
			
			jan = new Janela();
			jan.addEventListener(KeyboardEvent.KEY_DOWN,janelaOnKeyDown);
			jan.title = "Cadastrar Valor Parâmetro";
			jan.icone = "br/com/bancoob/imagens/icos/listaAplicativos/contacapital_16.png";									
			jan.addChild(DisplayObject(app));	
			jan.height = 546;
			jan.width = 700;
			app.cadastroValorConfiguracaoCapital = this;
