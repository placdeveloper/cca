package br.com.sicoob.sisbr.cca.render
{
	...
	public class CheckBoxRenderer extends AdvancedDataGridGroupItemRenderer
	{
		...
		private function checkBoxToggleHandler(event:MouseEvent):void
		{
			if (data)
			{
				...
				AdvancedDataGrid(myListData.owner).dispatchEvent(new FlexEvent(FlexEvent.DATA_CHANGE));
				
				//dispatchEvent(new Event("instituicaoChecada", true);
