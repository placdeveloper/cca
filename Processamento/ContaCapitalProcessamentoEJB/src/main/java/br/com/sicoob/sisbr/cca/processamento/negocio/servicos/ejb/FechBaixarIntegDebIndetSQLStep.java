...
public class FechBaixarIntegDebIndetSQLStep extends ContaCapitalProcessamentoStep {

	private static final ISicoobLogger LOG = getLogger(FechBaixarIntegDebIndetSQLStep.class);
	...
	public RetornoExecucao executar(ContextoExecucao ctx) {
		try {
			rodarFechamentoSQL(fechBaixarParcDebIndetServicoLocal, getNumCoop(ctx), EnumFechamento.ID_PROCESSO_BAIXA_INT_DEB_INDET_SQL.getIntValue());
			return sucesso();
