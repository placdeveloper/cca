...
public class FechDestinacaoJurosDB2Step extends ContaCapitalProcessamentoStep {

	private static final ISicoobLogger LOG = getLogger(FechDestinacaoJurosDB2Step.class);
	...
	public RetornoExecucao executar(ContextoExecucao ctx) {
		try {
			rodarFechamento(fechDestinacaoJurosServicoLocal, getNumCoop(ctx), EnumFechamento.ID_PROCESSO_DESTINA_JUROS_DB2.getIntValue());
			return sucesso();
