...
public class FechBaixarParcelaViaCCOSQLStep extends ContaCapitalProcessamentoStep {

	private static final ISicoobLogger LOG = getLogger(FechBaixarParcelaViaCCOSQLStep.class);
	...
	public RetornoExecucao executar(ContextoExecucao ctx) {
		try {
			rodarFechamentoSQL(fechBaixarParcViaCCOServicoLocal, getNumCoop(ctx), EnumFechamento.ID_PROCESSO_BAIXA_PARC_CCO_SQL.getIntValue());
			return sucesso();
